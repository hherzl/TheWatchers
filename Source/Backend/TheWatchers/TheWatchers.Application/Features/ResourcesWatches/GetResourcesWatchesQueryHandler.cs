...
public sealed class GetResourcesWatchesQueryHandler(IResourcesService service)
    : IRequestHandler<GetResourcesWatchesQuery, ListResponse<ResourceWatchItemModel>>
{
